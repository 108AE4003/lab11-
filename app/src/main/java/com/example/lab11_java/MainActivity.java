package com.example.lab11_java;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_query.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(MainActivity.this,"共有"+c.getCount()+
                        "笔资料",Toast.LENGTH_SHORT).show();
                for (int i=0;i<c.getCount();i++){
                    items.add("书名："+c.getString(0)+
                            "\t\t\t\t 价格："+c.getString(1));
                    c.moveToNext();
                }
        ...
        btn_insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if(ed_book.length()<1||ed_price.length()<1)
                    Toast.makeText(MainActivity.this,"栏位请勿留空",
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this,
                                "新增书名"+ed_book.getText().toString()
                                        +"价格"+ed_price.getText().toString(),
                                Toast.LENGTH_SHORT).show();
                        ed_book.setText("");
                        ed_price.setText("");
                    }catch (Exception e){
                        Toast.makeText(MainActivity.this,"新增失败："+
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ed_book.length()<1)
                    Toast.makeText(MainActivity.this,"书名请勿留空",
                            Toast.LENGTH_SHORT).show();
                else{
                    try{
                        dbrw.execSQL(" DELETE FROM myTable WHERE book LIKE'"+ed_book.getText().toString()+"'");
                        Toast.makeText(MainActivity.this,"删除书名"+
